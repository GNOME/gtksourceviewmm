...
static void SourceBuffer_signal_can_redo_callback(GtkSourceBuffer* self, gboolean p0,void* data)
{
...
static const Glib::SignalProxyInfo SourceBuffer_signal_can_redo_info =
{
  "can-redo",
...
static void SourceBuffer_signal_can_undo_callback(GtkSourceBuffer* self, gboolean p0,void* data)
{
  using namespace gtksourceview;
  typedef sigc::slot< void,bool > SlotType;
...
static const Glib::SignalProxyInfo SourceBuffer_signal_can_undo_info =
{
  "can-undo",
...
static void SourceBuffer_signal_marker_updated_callback(GtkSourceBuffer* self, GtkTextIter* p0,void* data)
{
  using namespace gtksourceview;
...
static const Glib::SignalProxyInfo SourceBuffer_signal_marker_updated_info =
{
  "marker-updated",
...
{
  return Glib::wrap(gtk_source_buffer_create_marker(gobj(), name.c_str(), type.c_str(), where.gobj()), true);
}
...
{
  return Glib::wrap(gtk_source_buffer_get_marker(gobj(), name.c_str()), true);
}
...
{
  return Glib::wrap(gtk_source_buffer_get_first_marker(gobj()), true);
}

Glib::RefPtr<SourceMarker> SourceBuffer::get_last_marker()
{
  return Glib::wrap(gtk_source_buffer_get_last_marker(gobj()), true);
}

Glib::RefPtr<SourceMarker> SourceBuffer::get_next_marker(Gtk::TextIter& iter)
{
  return Glib::wrap(gtk_source_buffer_get_next_marker(gobj(), iter.gobj()), true);
}

Glib::RefPtr<SourceMarker> SourceBuffer::get_prev_marker(Gtk::TextIter& iter)
{
  return Glib::wrap(gtk_source_buffer_get_prev_marker(gobj(), iter.gobj()), true);
}
