...
{
    if (a_buffer) {
        gtk_text_view_set_buffer (GTK_TEXT_VIEW (gobject_),
                                  GTK_TEXT_BUFFER (a_buffer->gobj ())) ;
    } else {
...
{
    Glib::RefPtr<const SourceBuffer> buffer =
        Glib::wrap ((GtkSourceBuffer*)get_buffer ()->gobj ());
    return buffer ;
}
...
SourceView::get_source_buffer ()
{
    Glib::RefPtr<SourceBuffer> buffer =
        Glib::wrap (reinterpret_cast<GtkSourceBuffer*> (get_buffer ()->gobj ())) ;
    return buffer ;
}
...
const Glib::SignalProxyInfo SourceView_signal_redo_info =
{
  "redo",
...
const Glib::SignalProxyInfo SourceView_signal_undo_info =
{
  "undo",
  (GCallback) &Glib::SignalProxyNormal::slot0_void_callback,
  (GCallback) &Glib::SignalProxyNormal::slot0_void_callback
